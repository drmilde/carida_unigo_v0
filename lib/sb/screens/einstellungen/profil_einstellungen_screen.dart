...
class _ProfilEinstellungenScreenState extends State<ProfilEinstellungenScreen> with TickerProviderStateMixin{
                                  ...
                                  children: [
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          _avatar(images[11], _controller.appConstants.turquoise),
                                          _avatar(images[12], _controller.appConstants.white),
                                          _avatar(images[13], _controller.appConstants.white),
                                          _avatar(images[14], _controller.appConstants.white),
                                          _avatar(images[15], _controller.appConstants.white),
                                          _avatar(images[16], _controller.appConstants.white),
                                          _avatar(images[17], _controller.appConstants.white),
                                          _avatar(images[18], _controller.appConstants.white),
                                          _avatar(images[19], _controller.appConstants.white),
                                          _avatar(images[20], _controller.appConstants.white),
                                          _avatar(images[21], _controller.appConstants.white),
                                        ],
                                      ),
                                    ),
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          _avatar(images[22], _controller.appConstants.turquoise),
                                          _avatar(images[23], _controller.appConstants.white),
                                          _avatar(images[24], _controller.appConstants.white),
                                          _avatar(images[25], _controller.appConstants.white),
                                          _avatar(images[26], _controller.appConstants.white),
                                          _avatar(images[27], _controller.appConstants.white),
                                          _avatar(images[28], _controller.appConstants.white),
                                          _avatar(images[29], _controller.appConstants.white),
                                          _avatar(images[30], _controller.appConstants.white),
                                          _avatar(images[31], _controller.appConstants.white),
                                          _avatar(images[32], _controller.appConstants.white),
                                        ],
                                      ),
                                    ),
                                  ],
