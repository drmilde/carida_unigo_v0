...
class UnigoOnboardingScreen extends StatefulWidget {
  const UnigoOnboardingScreen({Key? key}) : super(key: key);

  @override
  State<UnigoOnboardingScreen> createState() => _UnigoOnboardingScreenState();
}

class _UnigoOnboardingScreenState extends State<UnigoOnboardingScreen> {
